...
namespace MWGameplayTags
{
	...
	// Combat Command
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Attack_Up);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Attack_Down);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Attack_Left);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Attack_Right);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Dir_Up);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Dir_Down);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Dir_Left);
	MW_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_CC_Dir_Right);
