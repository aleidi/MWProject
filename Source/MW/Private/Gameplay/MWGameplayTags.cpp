...
#pragma region Battle Input
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterSkillSlot2,				"InputTag.TPBattle.CharacterSkillSlot2",					"Third-Person Battle Input Character Skill Slot 2.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterSkillSlot3,				"InputTag.TPBattle.CharacterSkillSlot3",					"Third-Person Battle Input Character Skill Slot 3.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterSkillSlot4,				"InputTag.TPBattle.CharacterSkillSlot4",					"Third-Person Battle Input Character Skill Slot 4.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_PartnerSkillSlot1,				"InputTag.TPBattle.PartnerSkillSlot1",						"Third-Person Battle Input Partner Skill Slot 1.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_PartnerSkillSlot2,				"InputTag.TPBattle.PartnerSkillSlot2",						"Third-Person Battle Input Partner Skill Slot 2.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_PartnerSkillSlot3,				"InputTag.TPBattle.PartnerSkillSlot3",						"Third-Person Battle Input Partner Skill Slot 3.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_PartnerSkillSlot4,				"InputTag.TPBattle.PartnerSkillSlot4",						"Third-Person Battle Input Partner Skill Slot 4.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterExtraSkillSlot1,			"InputTag.TPBattle.CharacterExtraSkillSlot1",				"Third-Person Battle Input Character Extra Skill Slot 1.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterExtraSkillSlot2,			"InputTag.TPBattle.CharacterExtraSkillSlot2",				"Third-Person Battle Input Character Extra Skill Slot 2.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(IATag_TPBattle_CharacterExtraSkillSlot3,			"InputTag.TPBattle.CharacterExtraSkillSlot3",				"Third-Person Battle Input Character Extra Skill Slot 3.");
