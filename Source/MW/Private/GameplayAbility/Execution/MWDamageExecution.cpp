...
struct MWDamageStatics
{
	...
	MWDamageStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UMWBattleSet, Endurance, Target, false);
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UMWBattleSet, Strength, Source, true);

		// Also capture the source's raw Damage, which is normally passed in directly via the execution
		DEFINE_ATTRIBUTE_CAPTUREDEF(UMWBattleSet, Damage, Source, true);
	}
};
